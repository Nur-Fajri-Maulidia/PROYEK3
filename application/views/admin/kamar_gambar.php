        ...
        <form action="<?php echo base_url().'admin/kamar_gambar_tambah_aksi' ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
                <div class="col-md-9">
                    ...
                    <input type="file" class="form-control" name="nama_gambar_Gedung" required="required">
                </div>
          </div>
          <div class="form-group">
                  <div class="col-md-9">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <center>
                      <h3>Nomer Gedung : <?php echo $no_kamar;  ?> </h3>
                      <h3>Harga Gedung : <?php echo rupiah($harga_kamar); ?> </h3>
                      <h3>Kelas Gedung : <?php echo $nama_kelas_kamar ?> </h3>
                      </center>
